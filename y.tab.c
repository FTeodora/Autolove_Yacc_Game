...
#define INDEX 260
#define SPEAKER 261
#define VAR_VALUE 262
#define TEXT_INPUT 263
#define VAR_SET 264
#define MARK_INPUT 265
#define VARI_SET 266
#define MAX_STAT 267
...
{
  "$end", "error", "$undefined", "EMOTION", "TEXT", "INDEX", "SPEAKER",
  "VAR_VALUE", "TEXT_INPUT", "VAR_SET", "MARK_INPUT", "VARI_SET",
  "MAX_STAT", "'<'", "'>'", "':'", "'%'", "$accept", "file", "statement",
  "speak", "specialCommand", "processInput", "spokesman", "sprite",
  "togglePrint", "speaking", "spokenText", "dialogueText",
  "processVariable", YY_NULLPTR
};
#endif
...
{
      10,    -4,    15,   -27,     2,   -27,   -27,   -27,   -10,   -27,
      -6,   -27,   -27,     6,    13,    17,   -27,   -27,     3,    22,
     -27,    -9,    14,   -27,   -27,    21,     1,   -27,   -27,    16,
       3,    25,    27,   -27,   -27,     3,   -27,   -27,    18,     5,
     -27,    21
};
...
{
       0,     0,     0,    16,     0,     2,     4,     5,     0,     6,
      13,    17,    10,     0,     0,     0,     1,     3,     0,     0,
      14,     9,     0,     8,    20,     0,     0,    18,    21,     0,
       0,     0,     0,     7,    19,     0,    11,    12,     0,     0,
      22,    15
};
...
{
      34,    11,    16,    18,    36,    24,    30,    24,     1,    24,
      19,    21,     2,    34,     3,    33,     1,    25,    22,    25,
       2,    41,     3,    12,    13,    29,    14,    23,    32,    31,
      37,    35,    38,    17,    40,    39
};

static const yytype_int8 yycheck[] =
{
      26,     5,     0,    13,    30,     4,    15,     4,     6,     4,
      16,     5,    10,    39,    12,    14,     6,    16,     5,    16,
      10,    16,    12,     8,     9,     3,    11,    10,     7,    15,
       5,    15,     5,     4,    16,    35
};
...
{
       0,     6,    10,    12,    18,    19,    20,    21,    23,    25,
      26,     5,     8,     9,    11,    22,     0,    19,    13,    16,
      24,     5,     5,    10,     4,    16,    27,    28,    29,     3,
      15,    15,     7,    14,    28,    15,    28,     5,     5,    27,
      16,    16
};
  ...
  case 9:
{
  ...
  case 11:
                                    {
        strcpy(metaInfo->globals[(yyvsp[-2].nr)],(yyvsp[0].s));
    }
    break;

  case 12:
                             {
        metaInfo->globalsi[(yyvsp[-2].nr)]=(yyvsp[0].nr);
    }
    break;
  ...
  case 15:
{
  ...
  case 17:
                       { strcpy(currDialogue.speaker,metaInfo->characters[(yyvsp[0].nr)].name);}
    break;

  case 18:
                         { strcpy(currDialogue.text,(yyvsp[0].s)); }
    break;
  ...
  case 22:
                                        { strcpy((yyval.s),metaInfo->globals[(yyvsp[-1].nr)]); }
    break;
