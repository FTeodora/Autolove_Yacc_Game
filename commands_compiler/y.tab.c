...
{
  "$end", "error", "$undefined", "TEXT", "OPTION", "PLACE", "TOPIC",
  "ASK", "CHECK", "RELOCATE", "DISCUSS", "DO", "GAME", "$accept",
  "command", "action", "question", "randomText", YY_NULLPTR
};
#endif
...
{
      12,     9,    10,    11,    14,    16,    13,     1,     2,     3,
       4,     5,    17
};

static const yytype_int8 yycheck[] =
{
       6,     4,     3,     5,     3,     0,    12,     7,     8,     9,
      10,    11,     3
};
...
#line 1396 "y.tab.c"
  ...
  case 9:
#line 63 "commands.y"
                     { int u=identifyWord((yyvsp[0].s),metaInfo->optionsNames,MAX_OPTIONS); printOptions(u); }
#line 1402 "y.tab.c"
    break;
